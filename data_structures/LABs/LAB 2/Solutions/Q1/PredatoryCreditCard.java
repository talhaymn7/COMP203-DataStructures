...
public class PredatoryCreditCard extends CreditCard {
  ...
  public PredatoryCreditCard(String cust, String bk, String acnt, int lim,
                             double initialBal, double rate, int charges) { //2 pts
    super(cust, bk, acnt, lim, initialBal);     // initialize superclass attributes
    apr = rate;
    n_charges = charges; //3 pts
 }
  ...
  public static void main(String[] args) {
    PredatoryCreditCard card = new PredatoryCreditCard("Michael", "Payday", "1111 1111 1111 1111", 2500, 0, 0.0825, 0);
    card.charge(1000);
